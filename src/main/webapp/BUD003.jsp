	...
	<div id="testheader">
		<div class="container">
			<div class=row>
				...
				<div class="col-md-1">
					<a style="margin-left: 700px; cursor:pointer;" class="logout btn btn-danger" onclick="showLogoutConfirmation()">Logout</a>
				</div>
			</div>
		</div>
		...
		<div class="main_contents">
			...
			<div id="sub_content">
				<form action="CourseRegisterServlet" method="post">
					...
					<div>${error}${error1}${success }</div>
					<div class="row mb-4">
						<div class="col-md-2"></div>
						<label for="id" class="col-md-2 col-form-label"> ID</label>
						<div class="col-md-4">
							<input type="email" class="form-control" id="id" value="${course.courseid}" name="courseid" readonly="true" />
						</div>
					</div>
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<input type="text" class="form-control" value="${course.coursename}" id="name" name="coursename">
						</div>
					</div>
