	...
	<div class="main_contents">
		<div id="sub_content">
			...
			<form>
				...
				<h2 class="col-md-6 offset-md-2 mb-5 mt-4">Student Detail</h2>
				${error}
				
				<div class="row mb-4">
					<img src='<c:url value="/resource/image/${res.photo}"/>' alt="profile_image" style="height: 70px; width: 100px; margin-left:520px; " />
				</div>
				...
				<div class="row mb-4">
					...
					<label for="studentID" class="col-md-2 col-form-label">Student
						ID</label>
					<div class="col-md-4">
						<input type="text" class="form-control" value="${res.id}"
							name="id" readonly>
					</div>
				</div>
				<div class="row mb-4">
				...
				<div class="row mb-4">
					...
					<div class="col-md-4">
						<select class="form-select" aria-label="Education" id="education"
							...
							<option value="2" ${res.edu eq 'Diploma in IT' ? 'selected' : ''}>Diploma
								in IT</option>
							<option value="3"
					...
					<div class="col-md-4">
						<c:forEach items="${list1}" var="list1">
							<div class="form-check-inline col-md-2">
								<input type="checkbox" name="attend" value="${list1.coursename}"
