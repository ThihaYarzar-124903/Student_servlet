	...
	<div id="testheader">
		<div class="container">
			<div class=row>
				...
				<div class="col-md-1">
					<a style="margin-left: 700px; cursor: pointer;"
						class="logout btn btn-danger" onclick="showLogoutConfirmation()">Logout</a>
				</div>
			</div>
		</div>
				...
				<form class="row g-3 mt-3 ms-2" action="UserSearchServlet"
					...
					<div class="col-auto">
						<label for="inputPassword2" class="visually-hidden">User
							Email</label> <input type="text" class="form-control" id="inputPassword2"
					...
					<div class="col-auto">
						<a href="/StudentRegistration/DisplayServlet">
					...
					<tbody>
						...
						<c:forEach items="${list}" var="course">
							<tr>
								...
								<td><a href="CourseUpdateServlet?id=${course.id}" class="btn btn-primary">Update</a></td>
								<td><a href="DeleteCourseServlet?id=${course.id}" onclick="return confirm('Are you sure want to delete?!');" class="btn btn-danger">Delete</a></td>
