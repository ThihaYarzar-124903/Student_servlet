...
<body>
	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				<form class="row g-3 mt-3 ms-2" action="StudentSearchServlet"
					method="get">
					...
					<div class="col-auto">
						...
						<input type="text" class="form-control" id="inputPassword2"
							placeholder="Course" name="attend">
					</div>
					<div class="col-auto">
						<button type="submit" class="btn btn-success mb-3">Search</button>
					</div>
					<div class="col-auto">
						<a href="/Student_Servlet/DisplayStudentServlet">
				...
				<div>
					<table class="table table-striped" id="stduentTable">
						...
						<tbody>
							<c:forEach items="${slist}" var="students">
								<tr>
									<td>${students.id }</td>
									<td>${students.name }</td>
									<td><c:forEach items="${students.attend}" var="attendance">
                							${attendance}
            							</c:forEach></td>
									<td><img
										src="${pageContext.request.contextPath}/resource/image/${students.photo}"
										style="height: 70px; width: 70px;"></td>
									<td><a href="SeeMoreServlet?name=${students.name}">
									       <button type="submit" class="btn btn-secondary mb-2">See More</button>
									    </a>
									</td>
									<td><a href="StudentUpdateServlet?sid=${students.sid}" class="btn btn-primary">Update</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
